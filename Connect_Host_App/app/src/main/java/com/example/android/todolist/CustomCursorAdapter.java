...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    */
    private int getPriorityColor(int priority) {
        int priorityColor = ContextCompat.getColor(mContext,R.color.materialYellow);

        switch(priority) {
            case 1: priorityColor = ContextCompat.getColor(mContext, R.color.colorPrimaryLight);
                break;
